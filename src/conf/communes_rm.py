...
# Code INSEE → nom officiel (casse d'usage) des 43 communes RM.
# Même source que CODES_INSEE_RM ; sert aux affichages et aux jointures
# référentielles (monitor.py) — COMMUNES_RM reste la référence nom→CP.
INSEE_VERS_NOM = {
